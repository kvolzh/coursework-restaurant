...
<nav class="navbar navbar-expand-lg  navbar-light bg-light">
    <div class="container-fluid">
    	...
    	<div class="col-sm-1"></div>
    	<div class="col-sm-6">
        	<a class="navbar-brand" href="#"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Админка</font></font></a>
              ...
              <tbody>
                <?php 
                  foreach ($reserve_info as $key => $value) {
                    $reserve_id = $value[0];
                    if ($value[5] == 0) {
                      $reserve = '<a href="reserve.php?reserve=1&reserve_id='.$reserve_id.'">Подтвердить</a>';
                    } else {
                      $reserve = '<a href="reserve.php?reserve=0&reserve_id='.$reserve_id.'">Отклонить</a>';
                    }
                    echo "<tr>
